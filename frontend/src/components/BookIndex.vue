<template>
  <div class="container">
    ...
    <div class="card" style="width: 18rem; float: left; margin: 5px" v-for="book in books" :key="book.id">      <router-link :to="{ name: 'books.show' , params: { id: book.id }}">
        <div class="card-body">
...
<script lang='ts'>
import useBooks from '../resourses/composables/books';
